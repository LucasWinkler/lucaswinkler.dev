...
export const listClass =
  '@container flex h-[clamp(18rem,52vh,34rem)] w-full select-none gap-2 [contain:layout] max-[900px]:h-[clamp(16rem,44vh,22rem)] max-[640px]:h-[clamp(20rem,56vh,28rem)] max-[640px]:w-screen max-[640px]:max-w-none max-[640px]:gap-0 max-[640px]:[margin-inline:calc(50%-50vw)] max-[640px]:snap-x max-[640px]:snap-proximity max-[640px]:[scroll-padding-inline:var(--section-padding-x)] max-[640px]:overflow-x-auto max-[640px]:[overflow-anchor:none] max-[640px]:[-webkit-overflow-scrolling:touch] max-[640px]:[scrollbar-width:none] max-[640px]:[&::-webkit-scrollbar]:hidden';
